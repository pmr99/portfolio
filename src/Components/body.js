...
const Body = () => {
    return (
        <div className = "body-container">
            ...
            <Card classname = "cardi" name = "JED Foundation Hub" role = "Project Manager / Designer" img = {crediblecover} text = "Created a central hub for JED Campus Advisors to deliver next generation mental & well-being resources to college campuses."> </Card>
