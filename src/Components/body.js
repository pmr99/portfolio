...
const Body = () => {
    return (
        <div className = "body-container">
            <Card classname = "cardi" name = "Enfactum" role = "UI Designer / Illustrator" link = "/portfolio/enfactum" img = {factum} text = "Enfactum is a creative agency that has pivoted its business model over the years. I redesigned its website to reflect its new direction."> </Card>
