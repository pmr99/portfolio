...
const Body = () => {
    return (
        <div className = "body-container">
            ...
            <Card classname = "cardi" name = "Invention Corpse Website" role = "Engineering Team Lead / Web Developer" img= {icbcover} text = "Originally coded in Vanilla HTML, it was troublesome to create regular updates to the website. We developed a new website using React, to make the website sustainable in the long-run."> </Card>
            <Card classname = "cardi" name = "GleanBee" role = "UX Researcher / UI Designer" link = "/gleanbee" img = {gleanprofile} text = "GleanBee is a data aggregating plug-in that simplifies curating information online. I redesigned the GleanBee platform and its plug-in, such that it is more intuitive and user-friendly for users. I also helped implement features using Angular."> </Card>
        </div>
    )
}
